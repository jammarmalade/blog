<?php includeJSCSS('editor');?><div class="post-area" style="margin-bottom:50px;">
	<div class="btn-group edit-bar" role="group">
		...
		<ul class="dropdown-menu">
		  <li><a href="javascript:;" onclick="editor('<?php echo $areaid;?>','code','php');">PHP</a></li>
		  <li><a href="javascript:;" onclick="editor('<?php echo $areaid;?>','code','javascript');">JavaScript</a></li>
		  <li><a href="javascript:;" onclick="editor('<?php echo $areaid;?>','code','html');">HTML</a></li>
		</ul>
