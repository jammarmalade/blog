<?php if(is_array($comlist)) foreach($comlist as $k => $com) { ?><div class="media comment-list" style="border:1px solid #fff;background-color:#fff;padding:5px;border-radius:5px;">
